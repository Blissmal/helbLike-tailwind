  ...
  return (
    <div className="flex flex-col items-center justify-start w-full p-4 space-y-6 overflow-x-hidden">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <CardHome
          text="Repay Loan"
          divColor="bg-orange-600"
          logo={<BiPieChart color="orange" />}
        />
        <CardHome
          text="HELB Student Loan Statement"
          divColor="bg-green-600"
          logo={<BsFillPersonBadgeFill color="green" />}
        />
        <CardHome
          text="Clearance Certificate"
          divColor="bg-red-600"
          logo={<BiBook color="red" />}
        />
      </div>
      ...
      <div className="w-full hidden lg:flex flex-col mt-6 rounded-full bg-blue-200 border border-blue-600 overflow-hidden">
        <div className="flex items-center justify-between">
          ...
          <div className="text-left flex-grow mx-4 relative">
            ...
            <p className="text-sm">
              You <span className="font-bold">MUST APPLY</span> for HELB STUDENT
              LOAN by selecting one of the Loan Product(s) below to access funds
              for meeting your program cost.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full flex flex-col p-6 mt-6 rounded-md bg-white border border-green-600">
        <h1 className="text-center text-xl font-semibold mb-4">
          ...
          <span className="text-red-600 hover:bg-red-600 hover:text-white rounded-full p-2 transition-colors duration-300 ease-in-out">
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              <tr>
                ...
                <td className="px-4 py-2 whitespace-nowrap">
                  <button className=" hover:bg-green-500 bg-green-600 text-white px-6 py-1 rounded-full transition-colors duration-300">
                    Open
                  </button>
                </td>
              </tr>
